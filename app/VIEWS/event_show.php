              ...
              <div class="mt-4 px-4">
                ...
                <form class="mx-5 my-5">
                  ...
                  <label class="relative block p-3 border-2 border-black rounded">
                    ...
                    <input class="w-full bg-transparent p-0 text-sm  text-gray-500 focus:outline-none" id="name" type="text" placeholder="<?= $event['name']; ?>" readonly />
                  </label>
                  ...
                  <label class="relative block p-3 border-2 mt-5 border-black rounded" >
                    ...
                    <input class="w-full bg-transparent p-0 text-sm  text-gray-500 focus:outline-none" id="name" type="text" placeholder="<?= $event['description']; ?>" readonly />
                  </label>
