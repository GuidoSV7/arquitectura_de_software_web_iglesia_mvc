...
<div class="lg:p-36 md:p-52 sm:20 p-8 w-full lg:w-1/2">
  ...
  <form action="#" method="POST">
    ...
    <div class="mb-4">
      ...
      <input type="confirm_password" id="confirm_password" name="confirm_password" class="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-500" autocomplete="off">
    </div>


    <div class="mb-6 text-blue-500">
      <a href="/" class="hover:underline">Ya eres miembro? Inicia Sesión</a>
    </div>
    <!-- Login Button -->
